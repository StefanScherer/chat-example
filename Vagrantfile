...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "server", primary: true do |server|
    ...
    server.vm.network :private_network, ip: "192.168.33.2" # VirtualBox
  ...
  config.vm.define "client01" do |client|
    ...
    client.vm.network :private_network, ip: "192.168.33.3" # VirtualBox
  ...
  config.vm.define "client02" do |client|
    ...
    client.vm.network :private_network, ip: "192.168.33.4" # VirtualBox
